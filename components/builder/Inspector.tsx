    ...
    return (
      <div className="h-full flex items-center justify-center text-center p-8">
        <div className="max-w-xs">
          ...
          <h3 className="text-lg font-semibold text-neutral-900 mb-2">No Block Selected</h3>
        ...
        {selectedBlock.type === 'header' && (
          <div>
            ...
            <button
              ...
              className="relative group w-20 h-20 rounded-full overflow-hidden border-4 border-neutral-200 bg-neutral-100 hover:border-neutral-400 transition-all"
            >
              <img
