...
export function HeaderBlockRenderer({ props }: HeaderBlockRendererProps) {
  return (
    <div className="flex flex-col items-center text-center space-y-0 p-6">
      <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white dark:border-neutral-700 shadow-">
        <img 
      ...
      <div>
        ...
        {props.location && (
          <div className="flex items-center justify-center gap-1 mt-2 text-sm text-neutral-500 dark:text-neutral-500">
