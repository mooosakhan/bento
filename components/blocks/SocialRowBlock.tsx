    ...
    <div className="flex items-center justify-center gap-4">
      {socials.map(({ key, icon: Icon, url, label }) => (
        <a
          ...
          aria-label={label}
          className="w-12 h-12 flex items-center justify-center bg-white border-2 border-neutral-200 rounded-full hover:border-neutral-900 hover:shadow-md transition-all duration-200"
        >
