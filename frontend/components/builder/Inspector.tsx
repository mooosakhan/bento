...
import { Trash2, Copy, Image as ImageIcon, Pencil, Backpack, MoveLeftIcon, ArrowLeftFromLine } from 'lucide-react';
      ...
      <div className="p-6 border-b border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800">
        <div className="flex items-center gap-3">
          ...
          <div className='flex gap-2'>
            <button className='bg-neutral-900 dark:bg-neutral-700 rounded-md px-2 py-1 text-white font-semibold hover:bg-neutral-800 dark:hover:bg-neutral-600 transition-colors' onClick={onDeselectBlock}>
              <ArrowLeftFromLine/>
            </button>
            <div>
              ...
              {['left', 'center', 'right'].map((align) => (
                <button
                  ...
                  className={`flex-1 px-3 py-2 rounded-lg font-medium text-sm transition-all ${
                    (selectedBlock.props.contentAlignment || 'left') === align
